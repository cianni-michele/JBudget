...
@DisplayName("Category Tag Tests")
class CategoryTagTest {

    private static final String TEST_TAG_NAME = "TestTagName";

    private static CategoryTag buildTestTag() {
        return buildTagNodeWithName(TEST_TAG_NAME);
    }

    private static CategoryTag buildTagNodeWithName(String name) {
        return buildTagNodeWithIdAndName(UUID.randomUUID(), name);
    }

    private static CategoryTag buildTagNodeWithIdAndName(UUID id, String name) {
        return new CategoryTag(id, name);
    }
    ...
    class ConstructorTests {
        ...
        class HierarchyTests {
            private CategoryTag rootTag;

            private CategoryTag childTag;

            private CategoryTag grandChildTag;
            ...
            class ChildTagTests {
                ...
                class GrandChildTagTests {
                    ...
                    void shouldCorrectlyAddAndContainChildren() {
                        ...
                        Set<Tag> children = Set.of(childTag, grandChildTag);

                        assertTrue(rootTag.isParentOf(children));
                    }
