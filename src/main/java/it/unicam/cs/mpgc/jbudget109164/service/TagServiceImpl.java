...
public class TagServiceImpl implements TagService {
    ...
    public Optional<Tag> getTagById(UUID id) {
        return Optional.ofNullable(repository.findById(id)).map(mapper::toModel);
    }
    ...
    public Tag updateTag(UUID id, String name) {
        ...
        repository.update(mapper.toDTO(updatedTag));
    ...
    public Tag addChildTag(UUID parentId, String childName) {
        ...
        repository.update(mapper.toDTO(parentTag));
        repository.save(mapper.toDTO(childTag));
        return childTag;
    }
